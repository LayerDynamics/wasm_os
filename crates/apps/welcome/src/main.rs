...
const SLIDES: &[Slide] = &[
    Slide {
        ...
        body: &[
            "An entire operating system running inside your browser tab.",
            "",
            "A real microkernel \u{2014} written in Rust, compiled to WebAssembly",
            "\u{2014} schedules processes and manages memory, files, and I/O.",
            "There is no server: everything here runs on your machine, in",
            "this one page.",
            "",
            "At startup, this is the only open window. The shell is waiting",
            "behind the Terminal — sh button in the taskbar.",
            "",
