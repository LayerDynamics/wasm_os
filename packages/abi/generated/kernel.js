...
const module0 = getCoreModule('kernel.core.wasm');
...
if (listKeys=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'listKeys', was 'listKeys' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
const { delete: _delete$2, get: get$2, listKeys: listKeys$2, put: put$2 } = imports['wasmos:abi/sys-store'];

if (_delete$2=== undefined) {
  const err = new Error("unexpectedly undefined instance import '_delete$2', was 'delete' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
if (get$2=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'get$2', was 'get' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}


if (listKeys$2=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'listKeys$2', was 'listKeys' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
if (put$2=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'put$2', was 'put' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
let gen = (function* _initGenerator () {
  ...
  const _trampoline8 = function(arg0, arg1, arg2) {
    ...
    var len0 = arg1;
    var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
    _debugLog('[iface="wasmos:abi/sys-store@0.1.0", function="get"] [Instruction::CallInterface] (sync, @ enter)');
    let hostProvided = true;
    ...
    _debugLog('[iface="wasmos:abi/sys-store@0.1.0", function="get"][Instruction::Return]', {
      funcName: 'get',
      paramCount: 0,
      async: false,
      postReturn: false
  ...
  _trampoline8.fnName = 'wasmos:abi/sys-store@0.1.0#get$2';
  ...
  const _trampoline9 = function(arg0, arg1, arg2, arg3) {
    ...
    var len1 = arg3;
    var result1 = new Uint8Array(memory0.buffer.slice(ptr1, ptr1 + len1 * 1));
    _debugLog('[iface="wasmos:abi/sys-store@0.1.0", function="put"] [Instruction::CallInterface] (sync, @ enter)');
    let hostProvided = true;
    ...
    _debugLog('[iface="wasmos:abi/sys-store@0.1.0", function="put"][Instruction::Return]', {
      funcName: 'put',
      paramCount: 1,
      async: false,
      postReturn: false
  ...
  _trampoline9.fnName = 'wasmos:abi/sys-store@0.1.0#put$2';
  
  const _trampoline10 = function(arg0, arg1) {
    var ptr0 = arg0;
    var len0 = arg1;
    var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
    _debugLog('[iface="wasmos:abi/sys-store@0.1.0", function="delete"] [Instruction::CallInterface] (sync, @ enter)');
    let hostProvided = true;
    ...
    _debugLog('[iface="wasmos:abi/sys-store@0.1.0", function="delete"][Instruction::Return]', {
      funcName: 'delete',
      paramCount: 1,
      async: false,
      postReturn: false
  ...
  _trampoline10.fnName = 'wasmos:abi/sys-store@0.1.0#_delete$2';
  
  const _trampoline11 = function(arg0, arg1, arg2) {
    var ptr0 = arg0;
    var len0 = arg1;
    var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
    _debugLog('[iface="wasmos:abi/sys-store@0.1.0", function="list-keys"] [Instruction::CallInterface] (sync, @ enter)');
    let hostProvided = true;
    ...
    dataView(memory0).setUint32(arg2 + 4, len2, true);
    dataView(memory0).setUint32(arg2 + 0, result2, true);
    _debugLog('[iface="wasmos:abi/sys-store@0.1.0", function="list-keys"][Instruction::Return]', {
      funcName: 'list-keys',
      paramCount: 0,
      async: false,
      postReturn: false
  ...
  _trampoline11.fnName = 'wasmos:abi/sys-store@0.1.0#listKeys$2';
  let exports2;
  let postReturn0;
  ...
  function boot(arg0) {
    var {sharedArrayBuffer: v0_0, crossOriginIsolated: v0_1, opfs: v0_2, jspi: v0_3, tier: v0_4 } = arg0;
    
    var encodeRes = _utf8AllocateAndEncode(v0_4, realloc0, memory0);
    var ptr1= encodeRes.ptr;
    var len1 = encodeRes.len;
    
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="boot"][Instruction::CallWasm] enter', {
      funcName: 'boot',
      paramCount: 6,
      async: false,
      postReturn: true,
    ...
    try {
      ret =   _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010Boot(v0_0 ? 1 : 0, v0_1 ? 1 : 0, v0_2 ? 1 : 0, v0_3 ? 1 : 0, ptr1, len1),
      });
    } catch (err) {
    ...
    var bool3 = dataView(memory0).getUint8(ret + 8, true);
    var bool4 = dataView(memory0).getUint8(ret + 9, true);
    var bool5 = dataView(memory0).getUint8(ret + 10, true);
    var bool6 = dataView(memory0).getUint8(ret + 11, true);
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="boot"][Instruction::Return]', {
      funcName: 'boot',
      paramCount: 1,
      async: false,
      postReturn: true
    ...
    task.resolve([{
      ready: bool2 == 0 ? false : (bool2 == 1 ? true : throwInvalidBool()),
      bootMillis: dataView(memory0).getInt32(ret + 4, true) >>> 0,
      features: {
        sharedArrayBuffer: bool3 == 0 ? false : (bool3 == 1 ? true : throwInvalidBool()),
        crossOriginIsolated: bool4 == 0 ? false : (bool4 == 1 ? true : throwInvalidBool()),
        opfs: bool5 == 0 ? false : (bool5 == 1 ? true : throwInvalidBool()),
        jspi: bool6 == 0 ? false : (bool6 == 1 ? true : throwInvalidBool()),
        tier: result7,
      },
    }]);
    const retCopy = {
  ...
  function mount(arg0, arg1) {
    ...
    switch (val1) {
      ...
      default: {
        ...
        throw new TypeError(`"${val1}" is not one of the cases of backend`);
      }
    }
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="mount"][Instruction::CallWasm] enter', {
      funcName: 'mount',
      paramCount: 3,
      async: false,
      postReturn: true,
    ...
    try {
      ret =   _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010Mount(ptr0, len0, enum1),
      });
    } catch (err) {
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="mount"][Instruction::Return]', {
      funcName: 'mount',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let control010FsWrite;
  
  function fsWrite(arg0, arg1) {
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="fs-write"][Instruction::CallWasm] enter', {
      funcName: 'fs-write',
      paramCount: 4,
      async: false,
      postReturn: true,
    ...
    try {
      ret =   _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010FsWrite(ptr0, len0, ptr1, len1),
      });
    } catch (err) {
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="fs-write"][Instruction::Return]', {
      funcName: 'fs-write',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let control010FsRead;
  
  function fsRead(arg0) {
    
    var encodeRes = _utf8AllocateAndEncode(arg0, realloc0, memory0);
    var ptr0= encodeRes.ptr;
    var len0 = encodeRes.len;
    
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="fs-read"][Instruction::CallWasm] enter', {
      funcName: 'fs-read',
      paramCount: 2,
      async: false,
      postReturn: true,
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="fs-read"][Instruction::Return]', {
      funcName: 'fs-read',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let control010FsList;
  
  function fsList(arg0) {
    
    var encodeRes = _utf8AllocateAndEncode(arg0, realloc0, memory0);
    var ptr0= encodeRes.ptr;
    var len0 = encodeRes.len;
    
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="fs-list"][Instruction::CallWasm] enter', {
      funcName: 'fs-list',
      paramCount: 2,
      async: false,
      postReturn: true,
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="fs-list"][Instruction::Return]', {
      funcName: 'fs-list',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let control010FsMkdirp;
  
  function fsMkdirp(arg0) {
    
    var encodeRes = _utf8AllocateAndEncode(arg0, realloc0, memory0);
    var ptr0= encodeRes.ptr;
    var len0 = encodeRes.len;
    
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="fs-mkdirp"][Instruction::CallWasm] enter', {
      funcName: 'fs-mkdirp',
      paramCount: 2,
      async: false,
      postReturn: true,
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010FsMkdirp',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'throw-result-err',
      callingWasmExport: true,
    ...
    try {
      ret =   _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010FsMkdirp(ptr0, len0),
      });
    } catch (err) {
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="fs-mkdirp"][Instruction::Return]', {
      funcName: 'fs-mkdirp',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let control010SeedEntropy;
  
  function seedEntropy(arg0) {
    var val0 = arg0;
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="seed-entropy"][Instruction::CallWasm] enter', {
      funcName: 'seed-entropy',
      paramCount: 2,
      async: false,
      postReturn: false,
    });
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010SeedEntropy',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    try {
      _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010SeedEntropy(ptr0, len0),
      });
    } catch (err) {
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="seed-entropy"][Instruction::Return]', {
      funcName: 'seed-entropy',
      paramCount: 0,
      async: false,
      postReturn: false
  ...
  function spawn(arg0) {
    var {name: v0_0, grantFsSubtree: v0_1, grantSpawn: v0_2, grantGpu: v0_3, grantInput: v0_4, grantSignal: v0_5, grantNet: v0_6 } = arg0;
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="spawn"][Instruction::CallWasm] enter', {
      funcName: 'spawn',
      paramCount: 9,
      async: false,
      postReturn: false,
    ...
    try {
      ret =   _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010Spawn(ptr1, len1, ptr2, len2, v0_2 ? 1 : 0, v0_3 ? 1 : 0, v0_4 ? 1 : 0, v0_5 ? 1 : 0, v0_6 ? 1 : 0),
      });
    } catch (err) {
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="spawn"][Instruction::Return]', {
      funcName: 'spawn',
      paramCount: 1,
      async: false,
      postReturn: false
  ...
  let control010SpawnEmulator;
  
  function spawnEmulator(arg0) {
    
    var encodeRes = _utf8AllocateAndEncode(arg0, realloc0, memory0);
    var ptr0= encodeRes.ptr;
    var len0 = encodeRes.len;
    
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="spawn-emulator"][Instruction::CallWasm] enter', {
      funcName: 'spawn-emulator',
      paramCount: 2,
      async: false,
      postReturn: false,
    });
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010SpawnEmulator',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    try {
      ret =   _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010SpawnEmulator(ptr0, len0),
      });
    } catch (err) {
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="spawn-emulator"][Instruction::Return]', {
      funcName: 'spawn-emulator',
      paramCount: 1,
      async: false,
      postReturn: false
  ...
  let control010AccountEmulator;
  
  function accountEmulator(arg0, arg1) {
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="account-emulator"][Instruction::CallWasm] enter', {
      funcName: 'account-emulator',
      paramCount: 2,
      async: false,
      postReturn: false,
    });
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010AccountEmulator',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    try {
      _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010AccountEmulator(toUint32(arg0), toUint64(arg1)),
      });
    } catch (err) {
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="account-emulator"][Instruction::Return]', {
      funcName: 'account-emulator',
      paramCount: 0,
      async: false,
      postReturn: false
  ...
  let control010DeliverNet;
  
  function deliverNet(arg0, arg1, arg2) {
    var val0 = arg2;
    var len0 = Array.isArray(val0) ? val0.length : val0.byteLength;
    var ptr0 = realloc0(0, 0, 1, len0 * 1);
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="deliver-net"][Instruction::CallWasm] enter', {
      funcName: 'deliver-net',
      paramCount: 4,
      async: false,
      postReturn: true,
    });
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010DeliverNet',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    try {
      ret =   _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010DeliverNet(toUint32(arg0), arg1 ? 1 : 0, ptr0, len0),
      });
    } catch (err) {
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="deliver-net"][Instruction::Return]', {
      funcName: 'deliver-net',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let control010ServiceSyscall;
  
  function serviceSyscall(arg0, arg1) {
    var val0 = arg1;
    var len0 = Array.isArray(val0) ? val0.length : val0.byteLength;
    var ptr0 = realloc0(0, 0, 1, len0 * 1);
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="service-syscall"][Instruction::CallWasm] enter', {
      funcName: 'service-syscall',
      paramCount: 3,
      async: false,
      postReturn: true,
    });
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010ServiceSyscall',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    try {
      ret =   _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010ServiceSyscall(toUint32(arg0), ptr0, len0),
      });
    } catch (err) {
    ...
    switch (dataView(memory0).getUint8(ret + 28, true)) {
      ...
      case 1: {
        var ptr5 = dataView(memory0).getUint32(ret + 36, true);
        var len5 = dataView(memory0).getUint32(ret + 40, true);
        var result5 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr5, len5));
        var bool6 = dataView(memory0).getUint8(ret + 44, true);
        variant7 = {
          pid: dataView(memory0).getInt32(ret + 32, true) >>> 0,
          imagePath: result5,
          terminalStdin: bool6 == 0 ? false : (bool6 == 1 ? true : throwInvalidBool()),
        };
        break;
      }
      default: {
    ...
    var result8 = new Uint32Array(memory0.buffer.slice(ptr8, ptr8 + len8 * 4));
    let variant10;
    switch (dataView(memory0).getUint8(ret + 56, true)) {
      ...
      case 1: {
        var ptr9 = dataView(memory0).getUint32(ret + 64, true);
        var len9 = dataView(memory0).getUint32(ret + 68, true);
        var result9 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr9, len9));
        variant10 = {
          pid: dataView(memory0).getInt32(ret + 60, true) >>> 0,
          url: result9,
        };
        break;
      }
    ...
    switch (dataView(memory0).getUint8(ret + 72, true)) {
      ...
      case 1: {
        variant11 = clampGuest(dataView(memory0).getUint8(ret + 73, true), 0, 255);
        break;
      }
      default: {
        throw new TypeError('invalid variant discriminant for option');
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="service-syscall"][Instruction::Return]', {
      funcName: 'service-syscall',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let control010DeliverStdin;
  
  function deliverStdin(arg0, arg1) {
    var val0 = arg1;
    var len0 = Array.isArray(val0) ? val0.length : val0.byteLength;
    var ptr0 = realloc0(0, 0, 1, len0 * 1);
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="deliver-stdin"][Instruction::CallWasm] enter', {
      funcName: 'deliver-stdin',
      paramCount: 3,
      async: false,
      postReturn: true,
    });
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010DeliverStdin',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    try {
      ret =   _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010DeliverStdin(toUint32(arg0), ptr0, len0),
      });
    } catch (err) {
    ...
    var len1 = dataView(memory0).getUint32(ret + 4, true);
    var result1 = new Uint32Array(memory0.buffer.slice(ptr1, ptr1 + len1 * 4));
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="deliver-stdin"][Instruction::Return]', {
      funcName: 'deliver-stdin',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let control010DeliverInput;
  
  function deliverInput(arg0, arg1) {
    var val0 = arg1;
    var len0 = Array.isArray(val0) ? val0.length : val0.byteLength;
    var ptr0 = realloc0(0, 0, 1, len0 * 1);
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="deliver-input"][Instruction::CallWasm] enter', {
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010DeliverInput',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    try {
      ret =   _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010DeliverInput(toUint32(arg0), ptr0, len0),
      });
    } catch (err) {
  ...
  let control010BindTerminal;
  
  function bindTerminal(arg0) {
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="bind-terminal"][Instruction::CallWasm] enter', {
      funcName: 'bind-terminal',
      paramCount: 1,
      async: false,
      postReturn: false,
    });
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010BindTerminal',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    try {
      _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010BindTerminal(toUint32(arg0)),
      });
    } catch (err) {
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="bind-terminal"][Instruction::Return]', {
      funcName: 'bind-terminal',
      paramCount: 0,
      async: false,
      postReturn: false
  ...
  let control010SetProcMem;
  
  function setProcMem(arg0, arg1) {
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="set-proc-mem"][Instruction::CallWasm] enter', {
      funcName: 'set-proc-mem',
      paramCount: 2,
      async: false,
      postReturn: false,
    });
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010SetProcMem',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    try {
      _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010SetProcMem(toUint32(arg0), toUint32(arg1)),
      });
    } catch (err) {
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="set-proc-mem"][Instruction::Return]', {
      funcName: 'set-proc-mem',
      paramCount: 0,
      async: false,
      postReturn: false
  ...
  let control010SetPriority;
  
  function setPriority(arg0, arg1) {
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="set-priority"][Instruction::CallWasm] enter', {
      funcName: 'set-priority',
      paramCount: 2,
      async: false,
      postReturn: false,
    });
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010SetPriority',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    try {
      _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010SetPriority(toUint32(arg0), toUint8(arg1)),
      });
    } catch (err) {
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="set-priority"][Instruction::Return]', {
      funcName: 'set-priority',
      paramCount: 0,
      async: false,
      postReturn: false
  ...
  let control010ExitCode;
  
  function exitCode(arg0) {
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="exit-code"][Instruction::CallWasm] enter', {
      funcName: 'exit-code',
      paramCount: 1,
      async: false,
      postReturn: false,
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010ExitCode',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    try {
      ret =   _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010ExitCode(toUint32(arg0)),
      });
    } catch (err) {
    ...
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      ...
      case 1: {
        variant0 = dataView(memory0).getInt32(ret + 4, true);
        break;
      }
      default: {
        throw new TypeError('invalid variant discriminant for option');
    ...
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="exit-code"][Instruction::Return]', {
      funcName: 'exit-code',
      paramCount: 1,
      async: false,
      postReturn: false
  ...
  let control010TakeCapture;
  
  function takeCapture(arg0) {
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="take-capture"][Instruction::CallWasm] enter', {
      funcName: 'take-capture',
      paramCount: 1,
      async: false,
      postReturn: true,
    });
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010TakeCapture',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    try {
      ret =   _withGlobalCurrentTaskMeta({
        taskID: task.id(),
        componentIdx: task.componentIdx(),
        fn: () => control010TakeCapture(toUint32(arg0)),
      });
    } catch (err) {
    ...
    var len1 = dataView(memory0).getUint32(ret + 12, true);
    var result1 = new Uint8Array(memory0.buffer.slice(ptr1, ptr1 + len1 * 1));
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="take-capture"][Instruction::Return]', {
      funcName: 'take-capture',
      paramCount: 1,
      async: false,
      postReturn: true
    });
    task.resolve([[result0, result1]]);
    const retCopy = [result0, result1];
  ...
  function listProcs() {
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="list-procs"][Instruction::CallWasm] enter', {
      funcName: 'list-procs',
      paramCount: 0,
      async: false,
      postReturn: true,
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      ...
      isAsync: false,
      isManualAsync: false,
      entryFnName: 'control010ListProcs',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: true,
    ...
    for (let i = 0; i < len2; i++) {
      ...
      var ptr0 = dataView(memory0).getUint32(base + 4, true);
      ...
      var result1 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr1, len1));
      result2.push({
        pid: dataView(memory0).getInt32(base + 0, true) >>> 0,
        name: result0,
        state: result1,
        priority: clampGuest(dataView(memory0).getUint8(base + 20, true), 0, 255),
        cpuTicks: BigInt.asUintN(64, BigInt(dataView(memory0).getBigInt64(base + 24, true))),
        memBytes: dataView(memory0).getInt32(base + 32, true) >>> 0,
        parent: dataView(memory0).getInt32(base + 36, true) >>> 0,
      });
    }
    _debugLog('[iface="wasmos:abi/control@0.1.0", function="list-procs"][Instruction::Return]', {
      funcName: 'list-procs',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  ({ exports: exports1 } = yield instantiateCore(yield module0, {
    ...
    'wasmos:abi/sys-store@0.1.0': {
      'delete': exports0['10'],
      get: exports0['8'],
      'list-keys': exports0['11'],
      put: exports0['9'],
    },
  }));
  ...
  postReturn0 = exports1['cabi_post_wasmos:abi/control@0.1.0#boot'];
  
  try {
    postReturn0Async = WebAssembly.promising(exports1['cabi_post_wasmos:abi/control@0.1.0#boot']);
  } catch(err) {
    postReturn0Async = exports1['cabi_post_wasmos:abi/control@0.1.0#boot'];
  }
  
  postReturn1 = exports1['cabi_post_wasmos:abi/control@0.1.0#mount'];
  
  try {
    postReturn1Async = WebAssembly.promising(exports1['cabi_post_wasmos:abi/control@0.1.0#mount']);
  } catch(err) {
    postReturn1Async = exports1['cabi_post_wasmos:abi/control@0.1.0#mount'];
  }
  
  postReturn2 = exports1['cabi_post_wasmos:abi/control@0.1.0#fs-write'];
  
  try {
    postReturn2Async = WebAssembly.promising(exports1['cabi_post_wasmos:abi/control@0.1.0#fs-write']);
  } catch(err) {
    postReturn2Async = exports1['cabi_post_wasmos:abi/control@0.1.0#fs-write'];
  }
  
  postReturn3 = exports1['cabi_post_wasmos:abi/control@0.1.0#fs-read'];
  
  try {
    postReturn3Async = WebAssembly.promising(exports1['cabi_post_wasmos:abi/control@0.1.0#fs-read']);
  } catch(err) {
    postReturn3Async = exports1['cabi_post_wasmos:abi/control@0.1.0#fs-read'];
  }
  
  postReturn4 = exports1['cabi_post_wasmos:abi/control@0.1.0#fs-list'];
  
  try {
    postReturn4Async = WebAssembly.promising(exports1['cabi_post_wasmos:abi/control@0.1.0#fs-list']);
  } catch(err) {
  ...
  postReturn6 = exports1['cabi_post_wasmos:abi/control@0.1.0#fs-mkdirp'];
  
  try {
    postReturn6Async = WebAssembly.promising(exports1['cabi_post_wasmos:abi/control@0.1.0#fs-mkdirp']);
  } catch(err) {
  ...
  try {
    postReturn8Async = WebAssembly.promising(exports1['cabi_post_wasmos:abi/control@0.1.0#service-syscall']);
  } catch(err) {
  ...
  control010Mount = exports1['wasmos:abi/control@0.1.0#mount'];
  ...
  control010FsMkdirp = exports1['wasmos:abi/control@0.1.0#fs-mkdirp'];
  control010SeedEntropy = exports1['wasmos:abi/control@0.1.0#seed-entropy'];
  control010Spawn = exports1['wasmos:abi/control@0.1.0#spawn'];
  control010SpawnEmulator = exports1['wasmos:abi/control@0.1.0#spawn-emulator'];
  control010AccountEmulator = exports1['wasmos:abi/control@0.1.0#account-emulator'];
  control010DeliverNet = exports1['wasmos:abi/control@0.1.0#deliver-net'];
  control010ServiceSyscall = exports1['wasmos:abi/control@0.1.0#service-syscall'];
  control010DeliverStdin = exports1['wasmos:abi/control@0.1.0#deliver-stdin'];
  control010DeliverInput = exports1['wasmos:abi/control@0.1.0#deliver-input'];
  control010BindTerminal = exports1['wasmos:abi/control@0.1.0#bind-terminal'];
  control010SetProcMem = exports1['wasmos:abi/control@0.1.0#set-proc-mem'];
  control010SetPriority = exports1['wasmos:abi/control@0.1.0#set-priority'];
  control010ExitCode = exports1['wasmos:abi/control@0.1.0#exit-code'];
  control010TakeCapture = exports1['wasmos:abi/control@0.1.0#take-capture'];
  control010ListProcs = exports1['wasmos:abi/control@0.1.0#list-procs'];
  const control010 = {
    accountEmulator: accountEmulator,
    bindTerminal: bindTerminal,
    boot: boot,
    deliverInput: deliverInput,
    deliverNet: deliverNet,
    ...
    setProcMem: setProcMem,
    spawn: spawn,
    spawnEmulator: spawnEmulator,
    takeCapture: takeCapture,
    
  };
  
  return { control: control010, 'wasmos:abi/control@0.1.0': control010,  };
})();
